...
export default function Map () {
  const loadKakaoMap = ()=> {
    window.kakao.maps.load(()=>{
      ...
      const mapOtion = {
        center: new window.kakao.maps.LatLng(DEFAULT_LAT, DEFAULT_LNG),//중심좌표
        level: 3,//확대크기
      };
      const map = new window.kakao.maps.Map(mapContainer, mapOtion);
      ...
      // 마커의 이미지정보를 가지고 있는 마커이미지를 생성합니다
        ...
        var content = `<div class= "infowindow">${store?.upso_nm}</div>`; //인포위도우에 표시될 내용
